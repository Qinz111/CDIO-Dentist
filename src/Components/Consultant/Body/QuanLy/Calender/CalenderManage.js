    ...
    <div className="modal-content">
        <div className="calendar-container">
            ...
            <div className="user-calendar-container">
                <FullCalendar plugins={[dayGridPlugin, timeGridPlugin, listPlugin]} initialView="timeGridDay"
                    events={dentist_manage.schedule || []} headerToolbar={{ left: "prev,next today" , center: "title" ,
                    right: "timeGridDay,timeGridWeek" , }} allDaySlot={false} slotMinTime="08:00:00"
                    slotMaxTime="18:00:00" height="auto" />
            </div>
        </div>
    </div>
</div>
