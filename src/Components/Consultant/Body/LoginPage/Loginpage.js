...
const Loginpage = () => {
    ...
    const GoAhead = async (event) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/api/v1/consultant/login', { email, password });
        ...
        <div className="login">
            ...
            <div className="login__card">
                ...
                <form onSubmit={GoAhead}>
                    ...
                    <button type="submit" className="login__button" onClick={headToHomePage}>Xác nhận</button>
                </form>
            </div>
        </div>
    );
