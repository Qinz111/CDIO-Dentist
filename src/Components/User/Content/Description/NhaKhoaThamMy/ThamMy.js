    ...
    <div className="container" id="thammy">
      <div className="thammy_container">
        <div className="thammy_title">
          <div className="thammy_title_header">NHA KHOA THẨM MỸ</div>
          <div className="thammy_title_detail">
        ...
        <div className="thammy_content">
          <div className="thammy_content_img">
            <img src={thammy} alt="" />
          </div>
          <div className="thammy_content_detail">
            <div className="thamy_content_detail_header1">
              <div className="thamy_content_detail_header1_top">
                Các Tình Trạng Răng Của Khách hàng
              </div>
              <div className="thamy_content_detail_header1_bot">
            ...
            <div className="thammy_content_detail_1">
              <div className="thammy_content_detail_bot1">
      ...
      <div className="thammy_loiich_container">
        ...
        <div className="loiich_content">
          <div className="loiich_img">
            <img src={loiich} alt="?" />
          </div>

          <div className="loiich_content_detail">
            <div
