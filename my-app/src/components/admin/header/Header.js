        ...
        <div className="header">
            ...
            <div className="header_bottom">
                <div className="header_bottom_left">
                    ...
                    <div className={`header_bottom_left_menu ${menuVisible ? 'show-menu' : ''}`}> 
                        <ul>
                            <li onClick={GoAheadDoctor}><a className="dropdown-item" href="#"><FaUserDoctor />Quản lý bác sĩ</a></li>
                            <li onClick={GoAheadConsultants}><a className="dropdown-item" href="#"><FaPhoneAlt />Quản lý tư vấn</a></li>
                        </ul>
                    </div>
                </div>
                <div className="header_bottom_right" onClick={ReturnHomepage}>
                    ...
                    <div className="header_bottom_right_text">
                        Đăng xuất
                    </div>
                </div>
            </div>
